...
from katana.units import NotEnglishAndPrintableUnit
...
class Unit(NotEnglishAndPrintableUnit):
    ...
    def add_arguments(cls, katana, parser):
        parser.add_argument('--brainfuck-input', action='store_true', default=None,
                            help='file to be read as input to brainfuck program')
        parser.add_argument('--brainfuck-timeout', action='store_true', default=1,
                            help='timeout in seconds to run brainfuck program')
