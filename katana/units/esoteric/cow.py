...
from katana.units import NotApplicable, PrintableDataUnit
...
class Unit(PrintableDataUnit):
    ...
    def add_arguments(cls, katana, parser):
        parser.add_argument('--cow-input', action='store_true', default=None,
                            help='file to be read as input to cow program')
        parser.add_argument('--cow-timeout', action='store_true', default=1,
                            help='timeout in seconds to run cow program')
