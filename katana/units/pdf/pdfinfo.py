...
class Unit(units.FileUnit):
    ...
    def add_arguments(cls, katana, parser):
        ...
        parser.add_argument('--pdf-owner-password', '-op', default="", type=str,
                            help='owner password for the given PDF')
    ...
    def evaluate(self, katana, case):
        ...
        p = subprocess.Popen(['pdfinfo', self.target.path, '-upw', katana.config['pdf_user_password'], '-opw',
                              katana.config['pdf_owner_password']], stdout=subprocess.PIPE, stderr=subprocess.PIPE)
