...
class Monitor(object):
    ...
    def on_work(self, manager: katana.manager.Manager,
                threadid: int, unit: katana.unit.Unit, case: Any):
    ...
    def on_artifact(self, manager: katana.manager.Manager,
                    unit: katana.unit.Unit, path: str = None) -> None:
