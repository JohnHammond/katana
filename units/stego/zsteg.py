...
DEPENDENCIES = [ 'zsteg' ]
permutations = list(set([ "b1,rgb,lsb,xy", "b1,r,lsb,xy", "b1,rgb,msb,yx", "b2,rgb,lsb,yx", "b2,rgb,lsb,xy","b1,rgba,lsb,xy", "b1,r,lsb,xy", "b1,rgba,msb,yx", "b2,rgba,lsb,yx", "b2,rgba,lsb,xy" ]))
...
class Unit(units.FileUnit):
	...
	def evaluate(self, katana, case):
		for args in permutations:
			...
			p = subprocess.Popen(['zsteg', self.target, args ], stdout = subprocess.PIPE, stderr = subprocess.PIPE)
