...
class Unit(EsotericUnit):
    ...
    def __init__( self, katana, parent, target ):
        ...
        katana.add_argument('--malbolge-file', action='store_true', default=False, help='target specifies a file name')
        katana.add_argument('--malbolge-input', default=sys.stdin, type=argparse.FileType('r'), help='the file to use for input')
